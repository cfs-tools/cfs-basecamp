...
3.	From the Basecamp GUI:
   a. Clone the [Pi IO Library](https://github.com/cfs-apps/pi_iolib)
   b. Clone the [GPIO Demo App]( https://github.com/cfs-apps/gpio_demo) 
   c. Run Basecamp’s app integration/build tool
