"""
    ...
    Notes:
      ...
      2. Includes an API for using EDS definitions to read/write file
         ...
         to define binary files in a psuedo telemetry packet.
      3. Psuedo telemetry messages are used becuase command function codes
...
class CfeFile(CfeEdsTarget):
    ...
    EDS and a "psuedo telmeetry" topic ID is used to identify the EDS messages
    ...
    def read(self, path_filename, topic_name):
        """
        TODO: Add psuedo telemetry CCSDS header with topic_id
        """
        self.path_filename = path_filename
        self.topic_name = topic_name 
        self.file_loaded = False
        self.file_data = None
        self.tbl_loaded = False
        self.tbl_data_array = []
        ...
        if path_filename not in (None,''):
            if os.path.isfile(path_filename):
                try:
                    ...
                    print(f'type(self.file_data) = {type(self.file_data)}') 
                    eds_entry, eds_obj = self.eds_mission.decode_message(bytes(self.file_data))
                    self.display_entries(eds_obj, eds_entry.Name)
                    self.tbl_loaded = True
    ...
    def write(self):
        """
        """
        self.write_file(self.path_filename)
    ...
    def reverse_eng(self):
        ...
        FILE_MGR_SYS_TBL_TLM = [                                                                             # CCSDS Headers (12 bytes)
            ...
            0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x01, 0x94, 0x00, 0x00, 0x00, 0x42,  # cFE1.... ...@...B
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  # ........ ........
        ...
        #self.save_file('file_mgr_sys_psuedo.tbl', bytes(FILE_MGR_SYS_TBL_TLM))
