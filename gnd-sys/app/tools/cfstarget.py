...
class ManageCfs():
    ...
    def add_usr_app_gui(self, usr_app_list):
        ...
        layout = [
                  ...
                  [sg.Text('', size=self.b_size), sg.Button('Build New', size=self.b_size, button_color=self.b_color, font=self.b_font, pad=self.b_pad, enable_events=True, key='-2_AUTO-')],
    ...
    def usr_app_status_gui(self, app_name_list):
        ...
        layout = [
                   [sg.Text("'Select <Details> for a complete installation status\n", font=hdr_value_font)],
                   app_layout,
    ...
    def app_install_status(self, app):
        ...
        summary_status = [True,  f'Invalid Installation', 'IndianRed3']
