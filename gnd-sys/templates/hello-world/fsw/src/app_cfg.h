...
#define CFG_@TEMPLATE@_SEND_STATUS_TOPICID  BC_SCH_4_SEC_TOPICID           // Use different CFG_ name instead of BC_SCH_4_SEC_TOPICID to localize impact if rate changes 
