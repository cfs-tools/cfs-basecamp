...
#define CFG_PROTO_CMD_TOPICID      PROTO_CMD_TOPICID
#define CFG_PROTO_EXE_TOPICID      PROTO_EXE_TOPICID
#define CFG_PROTO_SEND_HK_TOPICID  PROTO_SEND_HK_TOPICID
#define CFG_PROTO_HK_TLM_TOPICID   PROTO_HK_TLM_TOPICID
...
#define APP_CONFIG(XX) \
   ...
   XX(PROTO_CMD_TOPICID,uint32) \
   XX(PROTO_EXE_TOPICID,uint32) \
   XX(PROTO_SEND_HK_TOPICID,uint32) \
   XX(PROTO_HK_TLM_TOPICID,uint32) \
