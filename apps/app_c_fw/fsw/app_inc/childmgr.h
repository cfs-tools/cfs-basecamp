...
#define CHILDMGR_CONSTRUCTOR_EID                 (APP_C_FW_CHILDMGR_BASE_EID +  0)
#define CHILDMGR_MAIN_DISPATCH_EID               (APP_C_FW_CHILDMGR_BASE_EID +  1)
#define CHILDMGR_TASK_MAIN_CALLBACK_EID          (APP_C_FW_CHILDMGR_BASE_EID +  2)
#define CHILDMGR_REG_INVALID_FUNC_CODE_EID       (APP_C_FW_CHILDMGR_BASE_EID +  3)
#define CHILDMGR_EMPTY_TASK_Q_EID                (APP_C_FW_CHILDMGR_BASE_EID +  4)
#define CHILDMGR_INVALID_Q_READ_IDX_EID          (APP_C_FW_CHILDMGR_BASE_EID +  5)
#define CHILDMGR_TAKE_SEM_FAILED_EID             (APP_C_FW_CHILDMGR_BASE_EID +  6)
#define CHILDMGR_INVOKE_CHILD_ERR_EID            (APP_C_FW_CHILDMGR_BASE_EID +  7)
#define CHILDMGR_Get_CHILD_ERR_EID               (APP_C_FW_CHILDMGR_BASE_EID +  8)
#define CHILDMGR_DISPATCH_UNUSED_FUNC_CODE_EID   (APP_C_FW_CHILDMGR_BASE_EID +  9)
#define CHILDMGR_RUNTIME_ERR_EID                 (APP_C_FW_CHILDMGR_BASE_EID + 10)
#define CHILDMGR_DEBUG_EID                       (APP_C_FW_CHILDMGR_BASE_EID + 11)
