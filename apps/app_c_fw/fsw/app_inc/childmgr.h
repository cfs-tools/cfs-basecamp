...
#define CHILDMGR_CONSTRUCTOR_EID                 (CHILDMGR_BASE_EID +  0)
#define CHILDMGR_MAIN_DISPATCH_EID               (CHILDMGR_BASE_EID +  1)
#define CHILDMGR_TASK_MAIN_CALLBACK_EID          (CHILDMGR_BASE_EID +  2)
#define CHILDMGR_REG_INVALID_FUNC_CODE_EID       (CHILDMGR_BASE_EID +  3)
#define CHILDMGR_EMPTY_TASK_Q_EID                (CHILDMGR_BASE_EID +  4)
#define CHILDMGR_INVALID_Q_READ_IDX_EID          (CHILDMGR_BASE_EID +  5)
#define CHILDMGR_TAKE_SEM_FAILED_EID             (CHILDMGR_BASE_EID +  6)
#define CHILDMGR_INVOKE_CHILD_ERR_EID            (CHILDMGR_BASE_EID +  7)
#define CHILDMGR_Get_CHILD_ERR_EID               (CHILDMGR_BASE_EID +  8)
