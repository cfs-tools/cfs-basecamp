...
#define INITBL_CONFIG_DEF_ERR_EID  (APP_C_FW_INITBL_BASE_EID + 0)
#define INITBL_CFG_PARAM_EID       (APP_C_FW_INITBL_BASE_EID + 1)
#define INITBL_CFG_PARAM_ERR_EID   (APP_C_FW_INITBL_BASE_EID + 2)
#define INITBL_LOAD_JSON_EID       (APP_C_FW_INITBL_BASE_EID + 3)
#define INITBL_LOAD_JSON_ERR_EID   (APP_C_FW_INITBL_BASE_EID + 4)
