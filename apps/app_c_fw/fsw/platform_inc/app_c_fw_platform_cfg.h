...
#ifndef _app_c_fw_platform_cfg_h_
#define _app_c_fw_platform_cfg_h_

#include "app_c_fw_mission_cfg.h"
...
/******************************************************************************
** Application C Framework Error Codes
**
** TODO - This needs to be expanded and moved to framework utility
*/

#define  APP_C_FW_ERROR      (0x0001)
#define  APP_C_FW_CFS_ERROR  ((int32)(CFE_SEVERITY_ERROR | APP_C_FW_ERROR))
...
#endif /* _app_c_fw_platform_cfg_h_ */
