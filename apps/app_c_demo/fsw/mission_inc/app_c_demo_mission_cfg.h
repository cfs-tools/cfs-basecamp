...
**
**  Purpose:
**    Define mission scope configurations for the App C Demo app
**
**  Notes:
...
**       compile time. Use app_c_demo_platform_cfg.h for compile-time
...
#define _app_c_demo_mission_cfg_


#endif /* _app_c_demo_mission_cfg_ */
