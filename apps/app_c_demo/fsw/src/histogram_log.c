...
**       apps using the App C Framework.
                               ...
                               const INITBL_Class_t *IniTbl)
{
   ...
   strcpy(HistogramLog->Filename, APP_C_DEMO_UNDEF_TLM_STR);
      
   CFE_MSG_Init(CFE_MSG_PTR(HistogramLog->BinPlaybkTlm.TelemetryHeader), 
                   CFE_SB_ValueToMsgId(INITBL_GetIntConfig(IniTbl, CFG_APP_C_DEMO_BIN_PLAYBK_TLM_TOPICID)),
                   sizeof(APP_C_DEMO_BinPlaybkTlm_t));
