...
#define CFG_FILE_XFER_SEND_HK_TOPICID  FILE_XFER_SEND_HK_TOPICID
#define CFG_FILE_XFER_EXE_TOPICID      FILE_XFER_EXE_TOPICID
...
#define APP_CONFIG(XX) \
   ...
   XX(FILE_XFER_SEND_HK_TOPICID,uint32) \
   XX(FILE_XFER_EXE_TOPICID,uint32) \
